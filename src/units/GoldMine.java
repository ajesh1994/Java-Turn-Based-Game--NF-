...
/**
 * Class to represent the gold mine sprite
 * @author Helen
 *
 */
public class GoldMine implements Unit {
	
	/**Unit type*/
	private String unitType = "GoldMine";
	/**Team number of unit*/
	private int teamNo;
	...
	/**
	 * Method to get the gold mine image
	 * @return the gold mine image
	 */
	public BufferedImage getCharImg() {
		return ImageClass.mineImg;
	}
	...
	/**
	 * Method to get the amount of gold earned per turn
	 * @return the gold to be earned
	 */
