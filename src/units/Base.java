...
/**
 * Class to represent the base sprite
 * @author Helen
 *
 */
public class Base implements Unit {
	
	/**Unit type*/
	private String unitType = "Base";
	/**Team number of unit*/
	private int teamNo;
	...
	/**Cost of unit*/
	private int goldCost = 300;
	/**Gold earned per turn*/
	private int gained = 25;
	 ...
	 */
	public Base(int team, int player, int x, int y) {
		teamNo = team;
		playerNo = player;
		ImageClass.loadBase();
		setPosition(x, y);
	...
	/**
	 * Method to get the base image
	 * @return the base image
	 */
	public BufferedImage getCharImg() {
		return ImageClass.baseImg;
	}
